...
//        http
//                .csrf(csrf -> csrf.disable()) // no CSRF in stateless REST
//                .cors(cors -> cors.configurationSource(corsConfigurationSource()))
//                .authorizeHttpRequests(auth -> auth
//                        .requestMatchers("/api/login").permitAll()  // allow login
//                        .anyRequest().authenticated()               // all others need login
//                )
//                .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS)); // stateless mode
//        return http.build();
//    }
//
//
